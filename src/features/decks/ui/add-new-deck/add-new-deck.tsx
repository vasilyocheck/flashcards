...
import { Button, Checkbox, Modal, TextField } from '@/components'
import { useAddDeckMutation } from '@/features/decks'
import { UploadImg } from '@/features/decks/ui/add-new-deck/upload-img/upload-img'
